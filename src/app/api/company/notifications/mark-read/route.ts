...
export async function POST(request: NextRequest) {
    try {
        ...
        // Format: type_id (e.g., new_candidate_123)
        ...
        // Buscar a vaga para garantir que pertence a empresa
        ...
        // Initialize company_notifications if not exists
        ...
        if (type === 'new_candidate') {
            ...
            breakdown.company_notifications.new_candidate.read = true;
            ...
            breakdown.company_notifications.video_received.read = true;
            ...
            breakdown.company_notifications.video_expired_unsubmitted.read = true;
        }
