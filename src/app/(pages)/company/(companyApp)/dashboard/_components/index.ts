export { CompanyHero } from '@/src/app/(pages)/company/(companyApp)/dashboard/_components/Hero/Hero';
export { CompanyKPI } from '@/src/app/(pages)/company/(companyApp)/dashboard/_components/KPI/KPI';
