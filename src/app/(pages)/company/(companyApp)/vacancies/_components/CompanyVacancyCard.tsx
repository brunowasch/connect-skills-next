...
export function CompanyVacancyCard({ vacancy }: { vacancy: CompanyVacancy }) {
    ...
    return (
        <div className="group bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-shadow hover:border-blue-200">
            <div className="mb-4">
            ...
            <div className="flex items-center gap-3 pt-4 border-t border-gray-50 mt-4">
                <button
                    onClick={() => startTransition(() => selectVacancyForRanking(vacancy.id))}
