        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
            ...
            <div className="flex justify-between items-center mb-3">
                <div className="flex items-center gap-2 text-gray-800 font-bold">
                    ...
                    <span className="text-sm md:text-base">Complete seu perfil para melhores recomendações</span>
                </div>
            ...
            <div className="flex items-center gap-1.5 text-gray-400 mb-4">
                <Info size={14} />
                <p className="text-[12px]">* Empresas preferem perfis que tenham informações completas.</p>
            </div>
