...
export default function Sidebar({ mobileOpen = false, setMobileOpen }: SidebarProps) {
    ...
    const navItems = [
        { label: "Início", href: "/candidate/dashboard", icon: FaHome },
        { label: "Vagas", href: "/candidate/vacancies", icon: FaBriefcase },
        { label: "Meu Perfil", href: "/candidate/profile", icon: FaUser },
    ];
